...
export function Footer() {
  ...
  return (
    <footer className="relative mt-auto overflow-hidden" style={{
      ...
      <div className="h-px bg-gradient-to-r from-transparent via-[#DCB464]/60 to-transparent" />
      ...
      <div className="relative z-10 container mx-auto px-4 py-12">
        ...
        >
          ...
          <motion.div
            ...
            animate={{
              filter: [
                "drop-shadow(0 0 8px rgba(220,180,100,0.2))",
                "drop-shadow(0 0 16px rgba(220,180,100,0.4))",
                "drop-shadow(0 0 8px rgba(220,180,100,0.2))",
              ],
            }}
            transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}
          >
            <div className="h-16 w-16 rounded-full border-2 flex items-center justify-center" style={{ borderColor: "#DCB464", background: "rgba(220,180,100,0.08)" }}>
          ...
          <h3 className="text-lg font-semibold mb-1" style={{
            background: "linear-gradient(135deg, #DCB464, #FADCA0, #AA8228)",
        ...
        >
          <p className="text-gray-500 text-sm">
            ...
            <span className="font-bold" style={{
              background: "linear-gradient(135deg, #DCB464, #FADCA0)",
              WebkitBackgroundClip: "text",
              WebkitTextFillColor: "transparent",
            }}>JS-Innov.IA®</span>
          </p>
        ...
        <div className="flex justify-center">
          <button
            ...
            className="flex items-center gap-2 px-6 py-2 rounded-full border border-white/10 text-gray-500 text-xs uppercase tracking-[0.2em] hover:border-[#DCB464]/30 hover:text-gray-400 transition-all duration-300"
          >
            Mentions Légales
        ...
        >
          <div className="pt-6 flex flex-wrap justify-center gap-4 text-xs">
            <Link href="/mentions-legales" className="text-gray-500 hover:text-[#DCB464] transition-colors">
              Mentions légales
            </Link>
            <span className="text-gray-700">·</span>
            <Link href="/legal/cgu" className="text-gray-500 hover:text-[#DCB464] transition-colors">
              CGU
            </Link>
            <span className="text-gray-700">·</span>
            <Link href="/legal/privacy" className="text-gray-500 hover:text-[#DCB464] transition-colors">
              Politique de confidentialité
            </Link>
            <span className="text-gray-700">·</span>
            <Link href="/legal/cookies" className="text-gray-500 hover:text-[#DCB464] transition-colors">
              Cookies
            </Link>
            <span className="text-gray-700">·</span>
            <Link href="/contact" className="text-gray-500 hover:text-[#DCB464] transition-colors">
              Contact
            </Link>
          </div>
        </motion.div>
