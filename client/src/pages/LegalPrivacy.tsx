  ...
  return <div className="mmd-public-page mmd-legal-page">
    ...
    <section className="mmd-section"><div className="mmd-container mmd-legal-layout">
      ...
      <div className="mmd-legal-content">
        ...
        <LegalSection icon={<Database/>} title="2. Données traitées"><p>Selon votre utilisation : nom, prénom, coordonnées, date de naissance, adresse, taille, poids, catégorie de candidature, biographie, motivation, profession/études, réseaux sociaux facultatifs, photo, consentements, signatures simples horodatées, données techniques de connexion, votes, partages, commentaires et messages adressés à l’équipe.</p><p>Le formulaire public 2027 est ouvert de 16 à 26 ans. Pour un candidat mineur, le dossier recueille aussi le nom, l’email, le téléphone et la signature simple du représentant légal. Les informations et le PDF contractuel restent privés jusqu’à traitement par l’équipe.</p></LegalSection>
