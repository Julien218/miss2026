    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white flex items-center justify-center px-4 py-20">
      ...
      >
        ...
        <motion.div
          ...
          className="w-24 h-24 mx-auto mb-8 rounded-full bg-gradient-to-r from-[#DCB464] via-[#FADCA0] to-[#DCB464] flex items-center justify-center"
        >
        ...
        <motion.div
          ...
          className="bg-black/40 backdrop-blur-xl rounded-3xl border border-[#DCB464]/30 p-8 mb-8"
        >
          <h2 className="text-2xl font-bold mb-6 text-center">Prochaines étapes</h2>
          
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              <div className="w-8 h-8 rounded-full bg-[#DCB464] flex items-center justify-center flex-shrink-0 font-bold text-black">
                1
              </div>
              <div>
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-[#DCB464]/10 to-[#FADCA0]/10 rounded-2xl border border-[#DCB464]/30 p-6 mb-8"
        >
          <h3 className="font-bold mb-3 flex items-center gap-2">
            <Share2 className="w-5 h-5 text-[#DCB464]" />
            Maximisez vos chances !
          </h3>
          <ul className="space-y-2 text-sm text-[#C0C0C0]">
            <li className="flex items-start gap-2">
              <span className="text-[#DCB464] mt-1">•</span>
        ...
        >
          <Link href="/miss-mister-dour-2026">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="flex-1 px-6 py-4 rounded-xl bg-gradient-to-r from-[#DCB464] via-[#FADCA0] to-[#DCB464] text-black font-bold hover:shadow-lg hover:shadow-[#DCB464]/50 transition-all flex items-center justify-center gap-2"
            >
          ...
          <motion.button
            ...
            className="flex-1 px-6 py-4 rounded-xl bg-black/60 border border-[#DCB464]/30 text-white hover:border-[#DCB464] transition-colors flex items-center justify-center gap-2"
          >
        ...
        >
          <p>Des questions ? Contactez-nous à <a href="mailto:contact@miss-mister-dour.be" className="text-[#DCB464] hover:underline">contact@miss-mister-dour.be</a></p>
